    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.ConfigureApplicationCookie(options =>
            {
                ...
                // Redirection lorsqu'un utilisateur tente d'accéder à une page sans avoir les permissions requises
                options.AccessDeniedPath = $"/Account/Connection/AccessDenied"; // page à afficher en cas d'accès refusé
